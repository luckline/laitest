...
const checks = [
  ...
  },
  {
    name: "领测工作台",
    path: "/app",
    contains: ["AI QUALITY WORKSPACE", "product-nav.js?v=5", "lingtest-account.js?v=5", "app-shell-fix.css?v=5", "generation-history-1", "Standard", "Sketch", "Case Home JSON", "我的生成记录", "登录后次数翻倍", "PRO ACTIVATION", 'id="aiPrompt"'],
  },
  {
    name: "领测定价",
